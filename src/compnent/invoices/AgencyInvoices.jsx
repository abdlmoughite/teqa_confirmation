...
const INVOICE_TYPE_CONFIG = {
  PROVIDER_CREDIT: { label: "Payment Receipt", color: "emerald", icon: CheckCircle, description: "You received money", bgColor: "bg-emerald-100 dark:bg-emerald-500/10", textColor: "text-emerald-700 dark:text-emerald-400" },
  PROVIDER_INVOICE: { label: "Provider Invoice", color: "orange", icon: FileText, description: "Accounting document", bgColor: "bg-orange-100 dark:bg-orange-500/10", textColor: "text-orange-700 dark:text-orange-400" }
};
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        >
          ...
          <motion.button
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-medium shadow-md hover:shadow-lg transition-all"
          >
        ...
        {stats && stats.total_invoices > 0 && (
          ...
          >
            <StatCard 
              title="Total Amount" 
              value={formatPrice(stats.total_amount, stats.currency)} 
              subValue={`${stats.total_invoices} invoices`}
              icon={Wallet}
              gradient="from-blue-500 to-indigo-600"
            />
            <StatCard 
              title="Paid" 
              value={formatPrice(stats.paid_amount, stats.currency)} 
              icon={CheckCircle}
              gradient="from-emerald-500 to-green-600"
            />
            <StatCard 
              title="Pending" 
              value={formatPrice(stats.total_amount - stats.paid_amount, stats.currency)} 
              icon={Clock}
          ...
          <div className="flex flex-col md:flex-row gap-3">
            ...
            <div className="relative min-w-[180px]">
              ...
              >
                ...
                <option value="PROVIDER_CREDIT">Payment Receipts</option>
                      ...
                      >
                        ...
                        <td className="px-4 py-3">
                          <span className="text-xs text-gray-500">
                            {invoice.order_reference || (invoice.order_id ? "Linked order" : "—")}
                          </span>
                        </td>
                        <td className="px-4 py-3">
                        ...
                        <td className="px-4 py-3 hidden md:table-cell">
                          <p className="text-xs text-gray-500">{formatDate(invoice.issued_at || invoice.created_at)}</p>
                        </td>
                ...
                <div className="p-5 overflow-y-auto max-h-[60vh] space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="p-3 rounded-xl bg-gray-50 dark:bg-gray-800/50">
                      ...
                      <p className="text-sm font-medium text-gray-700 dark:text-gray-300">
                        {formatFullDate(selectedInvoice.issued_at || selectedInvoice.created_at)}
                      </p>
                    </div>
                  ...
                  <div className="p-3 rounded-xl bg-gray-50 dark:bg-gray-800/50">
                    ...
                    <p className="text-sm text-gray-800 dark:text-white">
                      {selectedInvoice.order_reference || (selectedInvoice.order_id ? "Linked order" : "—")}
                    </p>
                  </div>
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all font-medium"
                  >
                    <Wallet size={16} />
                ...
                <div className="p-5 space-y-4">
                  <div className="flex justify-between items-center py-2 border-b border-gray-100 dark:border-gray-800">
                    ...
                    <span className="font-bold text-gray-900 dark:text-white text-lg">
                      {formatPrice(transferDetails.amount, transferDetails.currency)}
                    </span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-gray-100 dark:border-gray-800">
                  ...
                  <div className="flex justify-between items-center py-2 border-b border-gray-100 dark:border-gray-800">
                    ...
                    <code className="text-xs font-mono text-gray-600 dark:text-gray-400">{transferDetails.reference || "—"}</code>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-gray-100 dark:border-gray-800">
                    <span className="text-sm text-gray-500">Date</span>
                    <span className="text-sm text-gray-700 dark:text-gray-300">{formatFullDate(transferDetails.created_at)}</span>
                  </div>
                  {transferDetails.note && (
                    <div className="pt-2">
                      <p className="text-xs text-gray-500 mb-1">Note</p>
                      <p className="text-sm text-gray-700 dark:text-gray-300">{transferDetails.note}</p>
                    </div>
                  )}
                </div>
