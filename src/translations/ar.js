export default {
  ...
  orders: {
    title: "لوحة تأكيد الطلبات",
    subtitle: "معاينة ثابتة مرتبطة بسير عمل CRM. يمكن لاحقا استبدال هذه البيانات بخدمة الطلبات الحقيقية.",
    agency_workspace: "مساحة الوكالة",
    agent_workspace: "مساحة الوكيل",
    search: "ابحث عن طلب أو عميل أو مدينة...",
  ...
  team: {
    title: "إدارة الفريق",
    subtitle: "أنشئ حسابات فرعية وحدد صلاحيات CRM بدقة.",
    create: "إنشاء مستخدم فرعي",
    full_access: "صلاحية كاملة",
    permissions: "الصلاحيات",
    existing: "المستخدمون الحاليون",
    existing_subtitle: "تحكم سريع في الحالة والصلاحيات.",
    accounts: "حسابات",
