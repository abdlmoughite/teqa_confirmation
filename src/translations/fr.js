export default {
  ...
  orders: {
    title: "Cockpit de confirmation",
    subtitle: "Apercu statique connecte au workflow CRM. Le vrai service orders pourra remplacer ces donnees plus tard sans changer le flux utilisateur.",
    agency_workspace: "Espace agence",
    agent_workspace: "Espace agent",
    search: "Chercher commande, client, ville...",
    all_sources: "Toutes les sources",
    metrics: {
      today: "Commandes du jour",
      confirmed: "Confirmees",
      urgent: "Urgentes",
      rate: "Taux de confirmation",
    },
    status: {
      new: "Nouveau",
  ...
  team: {
    ...
    subtitle: "Creez des comptes enfants et affectez des permissions CRM precises.",
    create: "Creer un utilisateur enfant",
    full_access: "Acces complet",
    permissions: "Permissions",
    existing: "Utilisateurs existants",
    existing_subtitle: "Controle rapide du statut et des permissions.",
    accounts: "comptes",
    empty: "Aucun compte enfant pour le moment.",
  },
