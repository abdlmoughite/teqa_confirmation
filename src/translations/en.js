export default {
  ...
  orders: {
    title: "Order confirmation cockpit",
    subtitle: "Static preview connected to your CRM workflow. The real order service can replace this dataset later without changing the user flow.",
    agency_workspace: "Agency workspace",
    agent_workspace: "Agent workspace",
    search: "Search order, client, city...",
  ...
  team: {
    ...
    subtitle: "Create child accounts and assign precise CRM permissions.",
    create: "Create child user",
    full_access: "Full access",
    permissions: "Permissions",
    existing: "Existing users",
    existing_subtitle: "Quick status controls and assigned permissions.",
    accounts: "accounts",
    empty: "No child accounts yet.",
  },
